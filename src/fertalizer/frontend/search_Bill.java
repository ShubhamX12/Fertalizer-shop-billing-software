...
public class search_Bill extends javax.swing.JFrame {
   ...
   Customer_billing c1=new Customer_billing(); 
    ...
    public search_Bill() {
        ...
        Object []data={"DATE","BILL NO","CUSTOMER NAME","phone number","TOTAL PRICE","PAID PRICE","REAMING PRICE"};
 ...
 String []s=c1.getSearchResultss(t1.getText().toString()); 
    ...
    private void j1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_j1ItemStateChanged
        ...
        if(!r.equals(""))
        {
        ArrayList<ArrayList<String>> l=c1.getproductdetails2(r);
    ...
    private void jy1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jy1PropertyChange
          int a=jy1.getYear(); 
           ...
           ArrayList<ArrayList<String>> s1=c1.getBillDateWiseInfo2(b);
           System.out.println(s1);
