...
public class Home_page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AGRO BILLING SOFTWARE");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(tm, javax.swing.GroupLayout.PREFERRED_SIZE, 254, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         ...
         try
        {
            ...
            else if(a<(Integer.parseInt(t13.getText()))+(Integer.parseInt(t11.getText())))
            {
            ...
            {
                JOptionPane.showMessageDialog(null,"Insufficent Stock");
            }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        if(c1.isinsertBill(t1.getText(),t3.getText(),s3.getText(),s5.getText(),s6.getText(),t2.getText()))
        {
...
"                                   LAXMI- NARAYAN AGO AGENCY,\n" +
"                           AT POST NIMSOD,TAL:KHATAVA,DIST:SATARA\n" +
"                           near  to bus stand ,Mobile No:8600339556"
                ...
                + "\n Name='"+s+"'\t \t BillNo:-\t"
                +"\n Address='"+t4.getText()+"'  \t\t Phone number='"+t5.getText()+"'"
                + "\n Date='"+t2.getText()+"' \t\t Time :-\t"
        ...
        t1.append("\n\n-----------------------------------------------------------------------------------------------------------------------------");
        t1.append("\n Total Price:-"+sum+"\tALL AMOUNT:"+s3.getText()); 
        t1.append("\n AMOUNT PAID:-"+s5.getText()+"\tREAMING AMOUNT:-"+s6.getText()+"\n");
